...
#[test]
pub fn equality() {
    assert_eq!(point(1.11111, 2.222222, 3.333333), point(1.11111, 2.222222, 3.333333));
    assert_eq!(vector(1.11111, 2.222222, 3.333333), vector(1.11111, 2.222222, 3.333333));

    assert_ne!(vector(1.11112, 2.222223, 3.333334), vector(1.11111, 2.222222, 3.333333));
    assert_ne!(point(1.11112, 2.222223, 3.333334), point(1.11111, 2.222222, 3.333333));

    assert_ne!(point(1.11111, 2.222222, 3.333333), vector(1.11111, 2.222222, 3.333333));
}

#[test]
pub fn addition() {
    assert_eq!(point(3.0, -2.0, 5.0) + vector(-2.0, 3.0, 1.0), point(1.0, 1.0, 6.0))
}
...
#[test]
pub fn negation() {
    assert_eq!(-Tuple {x: 1.0, y: -2.0, z: 3.0, w: -4.0}, Tuple {x: -1.0, y: 2.0, z: -3.0, w: 4.0});
}

#[test]
pub fn multiplication() {
    assert_eq!(Tuple {x: 1.0, y: -2.0, z: 3.0, w: -4.0} * 3.5, Tuple {x: 3.5, y: -7.0, z: 10.5, w: -14.0});
    assert_eq!(Tuple {x: 1.0, y: -2.0, z: 3.0, w: -4.0} * 0.5, Tuple {x: 0.5, y: -1.0, z: 1.5, w: -2.0});
}

#[test]
pub fn division() {
    assert_eq!(Tuple {x: 1.0, y: -2.0, z: 3.0, w: -4.0} / 2.0, Tuple {x: 0.5, y: -1.0, z: 1.5, w: -2.0});
}
...
pub fn cannon() {
    ...
    // println!("The cannonbal went {:?} units!", projectile.position.x);
