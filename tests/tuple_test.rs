...
mod tuple_test {
    ...
    use ray_tracer_challenge::matrix::is_equal_float;
    use ray_tracer_challenge::tuple::{is_point, is_vector, point, vector, Tuple};
    ...
    fn fire_to_file() {
        ...
        let mut canvas = Canvas::new(900, 550, black());
        ...
        let res = canvas.save_to_file("tests/output/kanon.ppm");
